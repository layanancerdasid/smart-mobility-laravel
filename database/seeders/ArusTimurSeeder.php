...
class ArusTimurSeeder extends Seeder
{
public function run(): void
    {
        $jsonPath = database_path('seeders/data/ARUS_LALU_LINTAS_TIMUR.json');
        ...
        collect($data)->chunk(100)->each(function ($chunk) {
            DB::table('arus_lalu_lintas_timur_2')->insert($chunk->toArray());
        });
    }
}
